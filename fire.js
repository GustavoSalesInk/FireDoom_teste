...
//função que vai olhar para o pixel de baixo e calcular seu valor
function updateFireIntensityPerPixel(currentPixelIndex) {
  ...
  //resultado do de cima anulando os valores menores do que 0
...
function renderFire() {
  //const debug = false
  let html = '<table cellpadding=0 cellspcing=0>'
...
//função para calcular a base do vetor
